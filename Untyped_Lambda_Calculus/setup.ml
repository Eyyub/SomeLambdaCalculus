...
(* OASIS_START *)
(* DO NOT EDIT (digest: d915857dbd10e69e3cda2884c3a9b0c4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "An untyped lambda calculus (inspired by TAPL book)";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\161\145\026\208\188\214\225.\250\139\205\156\n\167\006l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
