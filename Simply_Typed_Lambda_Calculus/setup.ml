...
(* OASIS_START *)
(* DO NOT EDIT (digest: 454f144a2deb4a8a5830811133603fa0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Eyyub (Eyy\195\188b SARI)"];
          homepage = None;
          synopsis = "A Simply Typed Lambda Calculus.";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "@\r\003\240\243\127\190\220;{\182\b\202m\207$";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
